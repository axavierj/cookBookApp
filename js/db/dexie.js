...
(function (global, factory) {
      ...
      function Transaction(
        ...
        if (mode !== "readonly")
          storeNames.forEach(function (storeName) {
            var _a;
            var yProps =
              (_a = dbschema[storeName]) === null || _a === void 0
                ? void 0
                : _a.yProps;
            if (yProps)
              storeNames = storeNames.concat(
                yProps.map(function (p) {
  ...
  function createDBCore(db, IdbKeyRange, tmpTrans) {
        ...
        return function (request) {
          return new Promise(function (resolve, reject) {
            ...
            var trans = request.trans,
              ...
              query = request.query;
            var direction =
              (_a = request.direction) !== null && _a !== void 0 ? _a : "next";
    ...
    var _a = extractSchema(db, tmpTrans),
      ...
      hasIdb3Features = _a.hasIdb3Features;
  ...
  function parseIndexSyntax(primKeyAndIndexes) {
    return primKeyAndIndexes.split(",").map(function (index, indexNum) {
      ...
      var type =
        (_a = typeSplit[1]) === null || _a === void 0 ? void 0 : _a.trim();
  ...
  function findCompatibleQuery(dbName, tableName, type, req) {
    ...
    switch (type) {
      case "query":
        var reqDirection_1 =
          (_a = req.direction) !== null && _a !== void 0 ? _a : "next";
        var equalEntry = entries.find(function (entry) {
          var _a;
          return (
            entry.req.limit === req.limit &&
            entry.req.values === req.values &&
            ((_a = entry.req.direction) !== null && _a !== void 0
              ? _a
              : "next") === reqDirection_1 &&
